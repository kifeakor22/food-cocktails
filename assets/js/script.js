...
let cocktailDetail = function (drinkIngListItem1,drinkIngListItem2,drinkIngListItem3,drinkIngListItem4,drinkIngListItem5,
    ...
    var drinkIngListItem1 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem1)
    var drinkIngListItem2 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem2)
    var drinkIngListItem3 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem3)
    var drinkIngListItem4 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem4)
    var drinkIngListItem5 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem5)
    var drinkIngListItem6 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem6)
    var drinkIngListItem7 = $("<li>").addClass("modal-body ingredient").text(drinkIngListItem7)
